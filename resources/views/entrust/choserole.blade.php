...
<div class="col-md-6 col-sm-12">
    <div class="white-box">
        <h3 class="box-title m-b-0">Select A Role</h3>
        <p class="text-muted m-b-30 font-13">This will detamine the functionalities you will have access to on the system</p>
        <div class="row">
